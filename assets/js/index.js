! function (e) {
	...
	}, n.p = "/opt/build/repo/docs", n(n.s = 62)
}([
	function (e, t, n) {
		"use strict";
	...
	function (e, t, n) {
		...
		t.typekitId = "ujh8grk", t.assetPath = "/assets/", t.cdnPath = "/assets/", t.videoCdnPath = i ? "/assets/" : "https://d8d3yaw9yoj7k.cloudfront.net/", t.dataFloatType = null, t.renderTargetFloatType = null, t.useFloatPacking = null, t.perspectiveScale = 1, t.heroVideoWidth = 1280, t.heroVideoHeight = 720, t.USE_GUI = !0, t.USE_SMAA = !1
	},
	function (e, t, n) {
		"use strict";
		var i = n(0);
		t.init = function (e, h, v) {
			if (r) return;
			r = t.renderer = e, o = t.gl = e.getContext(), t.MAX_VARYING_VECTORS = o.getParameter(o.MAX_VARYING_VECTORS), t.IS_SUPPORT_DEPTH_TEXTURE = !!e.extensions.get("WEBGL_depth_texture"), t.floatType = void 0 === h ? i.FloatType : h, t.dataFloatType = void 0 === v ? i.FloatType : v, t.precisionPrefix = "precision " + r.capabilities.precision + " float;\n", a = new i.Scene, (s = new i.Camera).position.z = 1, t.vertexShader = t.precisionPrefix + n(88), t.vertexNoUvShader = t.precisionPrefix + n(89), c = new i.Color, t.clearMaterial = new i.RawShaderMaterial({
				uniforms: {
					u_color: {
						value: new i.Vector4
					}
			...
			}), t.triGeom = new i.BufferGeometry, t.triGeom.setAttribute("position", new i.BufferAttribute(new Float32Array([-1, -1, 0, 4, -1, 0, -1, 4, 0]), 3)), t.quadGeom = new i.PlaneBufferGeometry(2, 2), (u = new i.Mesh(t.triGeom, t.copyMaterial)).frustumCulled = !1, a.add(u), l = new i.Scene;
			var m = new i.PlaneBufferGeometry(1, 1);
			m.translate(.5, -.5, 0), f = new i.RawShaderMaterial({
				uniforms: {
					u_texture: {
						value: null
					},
				...
				depthWrite: !1,
				blending: i.NoBlending
			}), d = new i.Mesh(m, f), l.frustumCulled = !1, l.add(d)
		}, t.copy = function (e, n) {
			var i = t.copyMaterial;
			i.uniforms.u_texture.value = e, h(i, n)
		}, t.clearColor = function (e, n, i) {
			c.setHex(e), t.clearMaterial.uniforms.u_color.value.set(c.r, c.g, c.b, n), h(t.clearMaterial, i)
		}, t.clearColorRGBA = function (e, n, i, r, o) {
			t.clearMaterial.uniforms.u_color.value.set(e, n, i, r), h(t.clearMaterial, o)
		}, t.renderGeometry = function (e, n, i) {
			u.geometry = e, h(n, i), u.geometry = t.triGeom
		}, t.renderObject = function (e, t) {
			u.visible = !1, a.add(e), r.setRenderTarget(t || null), r.render(a, s), t && r.setRenderTarget(null);
			a.remove(e), u.visible = !0
		}, t.render = h, t.debugTo = function (e, t, n, i, o) {
			e || console.warn("texture is missing");
			n = (t = t || 200) || 200, i = i || 0, o = o || 0;
			var a = r.getSize();
			i = i / a.width * 2 - 1, o = 1 - o / a.height * 2, t = t / a.width * 2, n = n / a.height * 2, f.uniforms.u_texture.value = e, f.uniforms.u_transform.value.set(i, o, t, n);
			var u = v();
			r.autoClearColor = !1, r.render(l, s), v(u)
		...
		}, t.getColorState = v, t.setColorState = function (e, t) {
			(t = t || r).setClearColor(e.clearColor, e.clearAlpha), t.autoClear = e.autoClear, t.autoClearColor = e.autoClearColor, t.autoClearStencil = e.autoClearStencil, t.autoClearDepth = e.autoClearDepth
		};
		var r = t.renderer = null,
			o = t.gl = null;
		t.precisionPrefix = null, t.floatType = null, t.dataFloatType = null, t.vertexShader = "", t.MAX_VARYING_VECTORS = 0, t.IS_SUPPORT_DEPTH_TEXTURE = null, t.quadGeom = null, t.triGeom = null, t.clearMaterial = null, t.copyMaterial = null;
		var a = void 0,
			s = void 0,
			u = void 0,
			c = void 0,
		...
		function h(e, t) {
			u.material = e, r.setRenderTarget(t || null), r.render(a, s), t && r.setRenderTarget(null)
		}
	...
	function (e, t, n) {
		...
		t.isSafari = !l && !f && u.indexOf("safari") > -1, t.isUC = u.indexOf("ucbrowser") > -1, t.isMac = c.indexOf("mac") > -1, t.isMobile = /(iPad|iPhone|Android)/i.test(u), t.isIOS = /(iPad|iPhone)/i.test(u), t.filterStyle = d ? i : v("filter"), t.transitionStyle = v("transition"), t.transformStyle = v("transform"), t.transform3dStyle = v("transform", "perspective"), t.transformPerspectiveStyle = v("perspective"), t.transformOriginStyle = v("transformOrigin"), t.WebAudioContext = a.AudioContext || a.webkitAudioContext, t.baseUrl = document.location.origin;
	...
	function (e, t, n) {
		...
		a.addChunk = function (e, t) {
			...
			if (t) {
				for (var n, r = this.itemList.splice(0, this.itemList.length), o = 0; o < t; o++) {
					n = r[o];
					var a = !!c[n.url];
					n.onLoaded.addOnce(m, this, -1024, n, r, a), n.hasLoading && n.loadingSignal.add(h, this, -1024, n, r, i), a ? n.dispatch(m) : n.isStartLoaded || this.queue.push(n)
				}
		...
		var s = e.exports = y();
		s.version = "0.1.9", s.register = function (e) {
			d[e.type] || (l.push(e), d[e.type] = e)
		}, s.retrieveAll = g, s.retrieve = x, s.testExtensions = _, s.create = y, s.load = f, s.check = function () {
			var e = [],
				t = [];
			for (var n in u) e.push(n), c[n] || t.push(u[n]);
			console.log({
				added: e,
				notLoaded: t
			})
		...
		function f(e, t) {
			var n = u[e];
			return n || (n = this._createItem(e, t && t.type ? t.type : x(e).type, t)), t && t.onLoad && n.onLoaded.addOnce(t.onLoad), c[e] ? n.dispatch() : n.isStartLoaded || n.load(), n
		}
		...
		function g(e, t) {
			...
			if (r && "string" != typeof e)
				for (n = 0; n < r; n++)(i = x(e[n], t)) && (o = o.concat(i));
	...
	function (e, t, n) {
		...
		t.init = function () {
			...
			t.onDowned.add(F, t, 1024), t.onMoved.add(z, t, 1024), t.onUped.add(E, t, 1024), t.onUped.add(k, t, -1024), window.addEventListener("touchmove", function (e) {
				e.preventDefault()
			}, {
				passive: !1
			})
		...
		function A(e, n) {
			...
			if (t.isFirstTouch === i && (t.isFirstTouch = A), A)
				for (c = e.touches.length ? e.touches[0] : e.changedTouches[0], S.x = a = c.pageX, S.y = s = c.pageY, S.target = b = c.target, S.identifier = c.identifier, S.touches = e.touches, t.prevBubbleHistory = t.currentBubbleHistory, l = t.currentBubbleHistory = S.bubbleHistory = []; b;) l.unshift(b), !D && I(b, R) && (D = S.isSkipPreventDefault = !0), b = b.parentNode;
			else
				for (S.identifier = 0, S.x = a = f ? e.pageX : e.clientX + h.scrollLeft, S.y = s = f ? e.pageY : e.clientY + h.scrollTop, S.target = b = e.target ? e.target : e.srcElement, t.prevBubbleHistory = t.currentBubbleHistory, l = t.currentBubbleHistory = S.bubbleHistory = []; b;) l.unshift(b), !D && I(b, R) && (D = S.isSkipPreventDefault = !0), b = b.parentNode; if (t.x = a, t.y = s, P) {
	...
	function (e, t, n) {
		...
		t.init = function (e) {
			...
			try {
				m = new l, M = m.createBiquadFilter(), P = m.createPanner(), T = m.createGain(), F() ? a.onDowned.addOnce(E) : t.gestureVolumeRatio = 1, M.connect(P), P.connect(T), T.connect(m.destination), (f = document.getElementById("snd-btn")).style.display = "block", (h = document.createElement("canvas")).width = h.height = D * L, f.appendChild(h), v = h.getContext("2d"), a.add(f, "click", O);
				var n = 0,
					i = 0;
			...
			p[e = e || "default"] || (p[e] = !0, o.loader.add(i.cdnPath + "audios/" + e + ".mp3", {
				...
				_onLoad: function () {
					...
					p[e] = this.xmlhttp.response, m ? z(e, t) : t()
				}
			}))
		}, t.isRequiredGesture = F, t.play = function (e) {
			if (!d || !m) return;
			R !== (e = e || "default") && (R && function (e) {
				if (y[e]) {
					y[e] = !1, S[e] && S[e].kill();
					var t = {
						onComplete: function () {
				...
				if (!y[e]) {
					...
					S[e] && S[e].kill(), w[e] = 0;
					var n = {};
					n[e] = 1, C && (n.delay = .5), S[e] = u.to(w, 1.5, n)
				}
			}(e));
			C = !1
			...
			M.frequency.value = s.clamp(a * c, 40, a), x[R];
			var l = n;
	...
	function (e, t, n) {
		...
		var i = n(1),
			...
			l = n(0);
		t.init = function () {
			document.documentElement.classList.add("is-ready"), x = document.getElementById("preloader"), _ = document.getElementById("preloader-canvas"), y = _.getContext("2d"), I = O(), A = O(!0), D = new l.Color, L = new l.Color(328965), x.style.backgroundColor = "transparent"
		}, t.resize = function (e, t) {
			M = _.width = e, P = _.height = t, R = P + 2 * (C = .4 * t)
		}, t.start = function (e) {
			e && F && F.kill();
			t.percent = 0, i.loader.start(function (n) {
		...
		}, t.show = N, t.update = function (e) {
			if ((t.visibleRatio = Math.min(this.showRatio, 1 - this.hideRatio)) > 0) {
				var n = t.showRatio + t.hideRatio - 1;
				D.set(16777215).lerp(L, t.initialRatio), y.fillStyle = D.getStyle(), y.clearRect(0, 0, M, P);
				var r = (R + P) * n;
				if (y.fillRect(0, r, M, P), t.showRatio < 1 && y.drawImage(A, 0, r + P - 1, M, C), t.hideRatio > 0 && y.drawImage(I, 0, r - C + 1, M, C), !T) {
					t.percentShowRatio;
					y.save(), y.globalAlpha = s.cUnMix(.75, 1, this.showRatio), y.translate(100 + (i.width >> 1) + 200 * (1 - t.percentShowRatio), (i.height - (i.width > 1280 ? 0 : o.HEIGHT) >> 1) + (i.width > 1280 ? 0 : o.HEIGHT));
					var u = 200 * a.easeInOutCubic(1 - s.cUnMix(0, .5, this.hideRatio));
					y.fillStyle = "rgba(255,255,255,0.05)", y.fillRect(-u, -2, u * t.percentShowRatio, 4), y.shadowBlur = 16, y.shadowColor = "rgba(255,255,255,0.45)", y.fillStyle = "#fff", y.fillRect(-u, -2, u * t.percent * t.percentShowRatio, 4), y.restore()
				}
			}
		}, t.initialRatio = 0, t.showRatio = 1, t.hideRatio = 0, t.visibleRatio = 0, t.percent = 0, t.percentShowRatio = 0, t.isAnimating = U, t.isIdle = function () {
		...
		function N() {
			if (!t.isAnimating()) {
				r.enable(!1), b = !0, f.dispatch(), x.style.display = "block";
				var e = {
					ease: "easeOutCubic"
				};
				g ? e.initialRatio = 1 : (t.showRatio = 0, t.hideRatio = 0, e.showRatio = 1), e.onComplete = function () {
					b = !1, h.dispatch(), w && V()
				}, c.set(t, {
					percentShowRatio: 1
				}), c.to(t, d ? 0 : z, e)
		...
		function H() {
			r.enable(!0), w = !1, S = !0, m.dispatch(), requestAnimationFrame(function () {
				c.to(t, d ? 0 : z, {
					hideRatio: 1,
					ease: "easeInCubic",
					onComplete: function () {
						x.style.display = "none", S = !1, g = !1, p.dispatch()
					}
				})
			})
		}
	...
	function (e, t, n) {
		"use strict";
		e.exports = n(7), n(63), n(64), n(38), n(65), n(66), n(67), n(68), n(39)
	},
	function (e, t, n) {
		"use strict";
		var i = n(39),
	...
	function (e, t, n) {
		...
		t.preInit = function () {
			...
			w.push(N("contact", "contact")), w.push(N("work", "featured")), y.push.apply(y, w), y.sort(function (e, t) {
				...
				autoUpdateStyles: !1,
				indicatorPadding: 32
			})).init(), O = document.getElementById("main-scroll-indicator").style
		}, t.init = function () {
			...
			C = C || t.currPage.getScrollToFromRoute(t.currPathInfo.route), window.addEventListener("popstate", ee), q(document.body), X(document.body), f.onShowStarted.add(V), f.onShowEnded.add(H), f.onLoadCompleted.add(W), f.onHideStarted.add(G), f.onHideEnded.add(j), f.onHideStarted.addOnce(B)
		}, t.resize = function (e, n) {
			t.currPage.resize(e, n)
		}, t.updateScrollPane = function () {
			b.onResize(), oe()
		}, t.scrollTo = se, t.update = function (e) {
			oe(), U += b._tPos < -1 ? -.03 : .05, U = g.clamp(U, 0, 1), O.opacity = U, !k && E < 1 && E !== b._tPos && (k = !0, v.setBaseText(""));
		...
		function B() {
			v.setBaseText(b.wrapper.dataset.scrollTooltip), E = b._tPos
		}
		...
		function G() {
			A || (M && M.parentNode === T && T.removeChild(M), t.currPage.hide(), (M = P).style.display = "block", q(M), X(M)), b.moveContainer.style.pointerEvents = "auto", t.currPathInfo = t.nextPathInfo, t.currPage = t.nextPage, t.nextPage = null, t.nextPathInfo = null, t.currPage.preShow(t.currPathInfo), l.play(t.currPage.audioId), v.setBaseText(""), x.onPageChange(t.currPathInfo), b.onResize(), se(C, !0), le(), A = !1
		}
		...
		function ae(e) {
			if (S = null, e.lang !== r.lang && (window.location.href = e.pathLangPrefix + e.pageUrl), e.aliasInfo)
				if (t.nextPathInfo = e, e.aliasInfo.isId) t.currPathInfo = t.nextPathInfo, se(e.aliasInfo.ref);
					...
					C = i.scrollTo, i.showTransition ? i.loadHTML ? (R = !0, r.loader.add(i.loadHTML, {
						type: "text",
						onLoad: function (e) {
		...
		function se(e, n) {
			C = null, t.isScrollingTo = !0, n && (b._tPos = 0);
	...
	function (e, t, n) {
		...
		t.preInit = function () {
			...
			f = new u({
				...
				forceSplitWidth: !0,
				delayWeight: .2
			}), e = document.getElementById("featured-desc"), v = new u({
				refDom: e
			}), m = new s({
				dom: e,
				delayWeight: .2
			...
			if (p) {
				f.testViewport(!0), h.resize(f.width), v.testViewport(!0), m.resize(v.width);
			...
			for (var t = "work" === e.route[0] && e.route.length > 1, n = 0, i = l.length; n < i; n++) {
				var r = l[n],
					o = !t || r.id != e.route[1];
			...
			if (p) {
				f.testViewport(), f.bottom > 0 && f.top < .65 * r.height ? g || (g = !0, h.show(1.5)) : f.top > r.height && g && (g = !1, h.hide(0)), v.testViewport(), v.bottom > 0 && v.top < .75 * r.height ? x || (x = !0, m.show(1.5)) : v.top > r.height && x && (x = !1, m.hide(0));
				for (var t = [
					[0, Math.abs(f.top + .5 * f.height - .5 * r.height)]
				], n = 0, a = l.length; n < a; n++) {
					var s = l[n];
					s.update(), t.push([n + 1, Math.abs(s.domRect.top + .5 * s.domRect.height - .5 * r.height)])
				}
				t.sort(_), r.isSupportWebGL && o.update(e, t[0][0]), i.isMac && i.isFirefox || (d.transform = "skewY(" + c.clamp(r.scrollTopVelocity / 20, -8, 8) + "deg) translateZ(0)")
			}
		};
		var l = [],
			d = void 0,
	...
	function (e, t, n) {
		...
		t.init = function (e) {
			...
			for (var t = new Float32Array(4 * D), U = 0, N = 0; N < D; N++) t[U + 0] = Math.random() - .5, t[U + 1] = Math.random() - .5, t[U + 2] = Math.random(), t[U + 3] = N / D, U += 4;
			var B = a.getColorState();
			if (a.renderer.autoClearColor = !1, r.useFloatPacking) {
				var V = new Uint8Array(4 * D),
					H = new Uint8Array(4 * D);
				O(t, V, H), (S = a.createDataTexture(V, 1, D, !0, !0, !0)).needsUpdate = !0, (T = a.createDataTexture(H, 1, D, !0, !0, !0)).needsUpdate = !0, l = c.clone(), f = c.clone(), v = h.clone(), p = h.clone(), a.clearColor(8355711, 0, m), a.clearColor(8355711, 0, p), u.u_prevPositionTextureZW = {
					value: l.texture
			...
			if (e.initialData) {
				...
				if (r.useFloatPacking) {
					...
					O(Y, ie, re), (W = a.createDataTexture(ie, A, D, !0, !0, !0)).needsUpdate = !0, (G = a.createDataTexture(re, A, D, !0, !0, !0)).needsUpdate = !0
				} else(W = a.createDataTexture(Y, A, D, !0, !0, !0)).needsUpdate = !0
			}
			a.setColorState(B), a.renderer.autoClearColor = !1, a.copyMaterial.transparent = !0, a.copy(W, d), r.useFloatPacking && a.copy(G, f);
			...
			}(P = new i.BufferGeometry).setAttribute("position", new i.BufferAttribute(ue, 3)), P.setAttribute("uv", new i.BufferAttribute(ce, 2)), P.setIndex(new i.BufferAttribute(le, 1)), R = new i.RawShaderMaterial({
				uniforms: {
			...
			}), i.Material.prototype.copy.call(C, R), R.defines.IS_FIRST_NODE = !0, r.useFloatPacking && (R.uniforms.u_positionTextureZW = u.u_currPositionTextureZW, R.uniforms.u_posPackDividers = u.u_posPackDividers, R.uniforms.u_rotPackDividers = u.u_rotPackDividers, R.defines.IS_PACKED = !0, C.defines.IS_PACKED = !0)
		}, t.update = function (e) {
			var t = a.getColorState();
			a.renderer.autoClearColor = !1,
			function () {
				var e = h;
				h = m, m = e, e = c, c = d, d = e, u.u_prevPositionTexture.value = c.texture, u.u_currPositionTexture.value = d.texture, u.u_prevVelocityTexture.value = h.texture, u.u_currVelocityTexture.value = m.texture, r.useFloatPacking && (e = v, v = p, p = e, e = l, l = f, f = e, u.u_prevPositionTextureZW.value = l.texture, u.u_currPositionTextureZW.value = f.texture, u.u_prevVelocityTextureZW.value = v.texture, u.u_currVelocityTextureZW.value = p.texture)
			}(), x.uniforms.u_dtRatio.value = o.deltaRatio, x.uniforms.u_noiseTime.value += .3 * e, x.uniforms.u_time.value += e, x.uniforms.u_initRatio.value = Math.min(1, x.uniforms.u_initRatio.value + .05 * e), a.render(x, m), r.useFloatPacking && a.render(_, p);
			y.uniforms.u_dtRatio.value = o.deltaRatio, y.uniforms.u_time.value = x.uniforms.u_time.value, y.uniforms.u_initRatio.value = x.uniforms.u_initRatio.value, y.uniforms.u_fixedScale.value = 2 * Math.tan(I.camera.fov / 360 * Math.PI) / o.resolution.y * 11, a.render(y, d), r.useFloatPacking && a.render(w, f);
			var n = C.uniforms,
				i = b,
				s = g;
			n.u_positionTexture.value = d.texture;
			for (var S = 2 / A, T = 1 / A, D = 0; D < A; D++) {
				R.uniforms.u_rotationTexture.value = i.texture, n.u_positionOffset.value.x = S * D, n.u_uvOffset.value.x = T * D, a.renderGeometry(M, 0 === D ? R : C, s);
				var L = i;
				i = s, s = L
			}
			var F = a.copyMaterial,
				z = F.transparent;
			F.transparent = !0, F.uniforms.u_texture.value = b.texture, a.renderGeometry(P, F, g), F.transparent = z, a.setColorState(t)
		};
		...
		function O(e, t, n) {
			for (var i = void 0, r = void 0, o = void 0, a = 0, s = 0, u = e.length; a < u; a++) i = (o = e[s + 0] / F * .5 + .5) % 1 - (r = 255 * o % 1) / 255, t[s + 0] = 255 * i, t[s + 1] = 255 * r, i = (o = e[s + 1] / F * .5 + .5) % 1 - (r = 255 * o % 1) / 255, t[s + 2] = 255 * i, t[s + 3] = 255 * r, i = (o = e[s + 2] / F * .5 + .5) % 1 - (r = 255 * o % 1) / 255, n[s + 0] = 255 * i, n[s + 1] = 255 * r, i = (o = e[s + 3] / z * .5 + .5) % 1 - (r = 255 * o % 1) / 255, n[s + 2] = 255 * i, n[s + 3] = 255 * r, s += 4
		}
	},
	function (e, t) {
	...
	function (e, t, n) {
		...
		t.preInit = function (e) {
			...
			t._actionId = _ ? _ === g ? "jump" : "slide" : "", t._actionRatio = n, m.update(e), r.useFloatPacking || u.update(e)
		...
		function b(e) {
			(f = e.scene.children[0].children[1]).add(e.scene.children[0].children[0]), f.animations = e.animations, r.useFloatPacking || u.init(f), f.material = new i.MeshBasicMaterial({
				color: 16722761,
				skinning: !0,
				transparent: !0,
				opacity: .15
		...
		function T() {
			r.useFloatPacking || u.emit(), v.material.uniforms.u_emitRatio.value = 1
		}
	},
	function (e, t, n) {
		"use strict";
	...
	function (e, t, n) {
		...
		t.preInit = function () {}, t.init = function (e) {
			...
			_.getInverse(i.projectionMatrix), S.u_projectionViewInverse.value.multiplyMatrices(i.matrixWorld, _), S.u_noiseTime.value = (S.u_noiseTime.value + e) % 2.142, S.u_time.value += e;
			for (var r = 0; r < b; r++) {
				var o = g[r],
					a = o.spotLight;
	...
	function (e, t, n) {
		...
		function R() {
			...
			}), o.USE_GUI = !1, a.simplex = new y, d.init(), u.init(), m.init(), x.init(), c.preInit(), T = new w.Vector2, a.prevMouse = new w.Vector2(0, 0), a.mouse = new w.Vector2(0, 0), a.mouseVel = new w.Vector2(0, 0), a.elasticMouse = new w.Vector2(0, 0), a.elasticMouseVel = new w.Vector2(0, 0), a.easedMouse = new w.Vector2(0, 0), a.easedMouseVel = new w.Vector2(0, 0), a.mobileOrientation = new w.Vector4, window.addEventListener("resize", D), window.addEventListener("orientationchange", D), D(), u.onDowned.add(A), u.onMoved.add(A), S || (t.isRendering = !0, a.currentTime = +new Date, L()), m.onLoadCompleted.addOnce(C, null, 1024), m.start(!1), m.show()
		}
		...
		function D(e) {
			...
			if (m.resize(t, n), document.documentElement.style.setProperty("--vh", .01 * i + "px"), P) {
				if (e) {
					var r = t >> 1,
						o = i >> 1;
					a.prevMouse.set(r, o), a.mouse.copy(a.prevMouse), a.elasticMouse.copy(a.prevMouse), a.easedMouse.copy(a.prevMouse), a.mouseVel.set(0, 0), a.elasticMouseVel.set(0, 0), a.easedMouseVel.set(0, 0)
				}
		...
		i = window, a.isSupportWebGL = _.checkIsSupported(a.canvas = document.getElementById("canvas")), "Promise" in i && a.isSupportWebGL ? R() : (a.isSupportWebGL = !1, document.documentElement.classList.add("no-webgl"), R())
	},
	function (e, t, n) {
		"use strict";
		var i = n(14),
	...
	function (e, t, n) {
		...
		function o(e, n) {
			s || t.init(), this.width = 1, this.height = 1, this.useScissor = !1, this.scissorRect = new i.Vector4, this.scene = null, this.camera = null, this.preserveScene = e, this.resolution = new i.Vector2(0, 0), this.fullResolution = new i.Vector2(0, 0), this.fromRenderTarget = r.createRenderTarget(1, 1, !0), this.fromRenderTarget.depthBuffer = !0, this.fromRenderTarget.stencilBuffer = !0, this.toRenderTarget = this.fromRenderTarget.clone(), this.prevSceneRenderTarget = e ? this.fromRenderTarget.clone() : null, this.sceneRenderTarget = e ? this.fromRenderTarget.clone() : null, this.useDepthTexture = !!n, this.useDepthTexture && (this.depthTexture = new i.DepthTexture, this.depthTexture.type = i.UnsignedShortType, this.depthTextureUniform = {
				value: this.depthTexture
			}), this.fromTexture = this.fromRenderTarget.texture, this.toTexture = this.toRenderTarget.texture, this.prevSceneTexture = e ? this.prevSceneRenderTarget.texture : null, this.sceneTexture = e ? this.sceneRenderTarget.texture : null, this.willToScreen = !1, this.mesh = new i.Mesh, this.queue = []
		}
		var a = o.prototype;
		t = e.exports = o, a.swap = function () {
			...
			this.width = e, this.height = t, this.resolution.set(e, t), this.fullResolution.set(e, t), this.preserveScene && (this.sceneRenderTarget.setSize(e, t), this.prevSceneRenderTarget.setSize(e, t));
			...
			if (i.setRenderTarget(null), i.setScissorTest(!1), this.preserveScene) {
				...
				this.prevSceneRenderTarget = this.sceneRenderTarget, this.sceneRenderTarget = l, this.prevSceneTexture = this.prevSceneRenderTarget.texture, this.sceneTexture = this.sceneRenderTarget.texture
			}
			if (o.length) {
				this.beforeRenderOut(), this.useDepthTexture && (this.fromRenderTarget.depthTexture = this.depthTexture), i.setRenderTarget(this.fromRenderTarget), i.render(e, t), this.useDepthTexture && (this.fromRenderTarget.depthTexture = null), this.preserveScene && r.copy(this.fromRenderTarget.texture, this.sceneRenderTarget);
				var d = r.getColorState();
				i.autoClear = !1;
				for (var f = 0, h = o.length; f < h; f++) {
					var v = f === h - 1 && n;
					(a = o[f]).setPostprocessing(this), a.render(this, v)
				}
				this.afterRenderOut(), r.setColorState(d)
			} else {
				...
				i.setRenderTarget(null), i.setScissorTest(!0), i.setViewport(m.x, this.height - m.y - m.w, m.z, m.w), i.setScissor(m.x, this.height - m.y - m.w, m.z, m.w), this.preserveScene ? (this.beforeRenderOut(), r.copy(this.sceneRenderTarget.texture), this.afterRenderOut()) : (this.beforeRenderOut(), i.setRenderTarget(null), i.render(e, t), this.afterRenderOut()), i.setScissorTest(!1)
			}
		};
		var s = t.geom = null,
			u = t.vrGeom = null;
	...
	function (e, t, n) {
		...
		t.init = function (e) {
			...
			function () {
				...
				depthWrite: !1,
				depthTest: !1
			}), r.copy(g, v), i.useFloatPacking && (u.u_prevPositionTextureZW = {
				value: null
			}, u.u_currPositionTextureZW = {
				value: null
			...
			n = h, h = v, v = n, u.u_prevPositionTexture.value = h.texture, u.u_currPositionTexture.value = v.texture, i.useFloatPacking && (n = m, m = p, p = n, u.u_prevPositionTextureZW.value = m.texture, u.u_currPositionTextureZW.value = p.texture), _.uniforms.u_time.value += .3 * e, _.uniforms.u_rebornCenter.value.y = 2 * c.cameraPosition.y + 1, r.render(_, v), i.useFloatPacking && r.render(y, p);
			var n;
			r.setColorState(t)
		};
		var u = t.sharedUniforms = {},
	...
	function (e, t, n) {
		...
		m.constructor = h, m.preInit = function () {
			i.ShaderChunk.homeHeroColorRemap = n(136).replace(/#define\sGLSLIFY\s./, ""), v.preInit.call(this), this.sharedUniforms = {
		...
		(function (global) {
			...
			function () {
				...
				for (_ = 0; _ < t; _++) {
					...
					for (g = 0; g < y - 2; g++) {
						...
						for (i = numeric.house(n), h = numeric.getBlock(e, [g + 1, g], [R, y - 1]), v = numeric.tensor(i, numeric.dot(i, h)), p = g + 1; p <= R; p++)
							for (f = e[p], m = v[p - g - 1], x = g; x < y; x++) f[x] -= 2 * m[x - g];
						for (h = numeric.getBlock(e, [0, g + 1], [y - 1, R]), v = numeric.tensor(numeric.dot(h, i), i), p = 0; p < y; p++)
							for (f = e[p], m = v[p], x = g + 1; x <= R; x++) f[x] -= 2 * m[x - g - 1];
						for (h = Array(R - g), p = g + 1; p <= R; p++) h[p - g - 1] = w[p];
						for (v = numeric.tensor(i, numeric.dot(i, h)), p = g + 1; p <= R; p++)
				...
				for (o = 0; o < w; o++)
					...
					for (o = 0; o < w; o++) f = C.getRow(o), C.setRow(o, f.div(f.norm2()));
				return C = C.transpose(), C = T.transjugate().dot(C), {
					lambda: R.getDiag(),
					E: C
				}
				...
				for (r = 0; r !== b; ++r) {
					...
					for (a = (o = P[r]) + l, P[r + 1] = a, i = l - 1; - 1 !== i; --i) f = o + i, n = M[i], R[f] = n, C[f] = S[n], T[n] = 0, S[n] = 0;
					P[r + 1] = P[r] + l
				}
				return I
			...
			function () {
				...
				for (s = 0; s !== A; ++s) {
					for (l = i[s], d = r[s], f = o[s], h = a[s], v = [], u = 0; u !== D; u++) {
						for (u > 0 && d[u] * l[u] < 0 && v.push(n[u]), b = n[u + 1] - n[u], n[u], g = l[u], x = d[u + 1], m = f[u] / b, _ = (p = h[u + 1] / b) + 3 * g + 2 * m - 3 * x, y = 3 * (p + m + 2 * (g - x)), (w = e(m - p + 3 * (g - x)) + 12 * p * g) <= 0 ? S = (T = _ / y) > n[u] && T < n[u + 1] ? [n[u], T, n[u + 1]] : [n[u], n[u + 1]] : (T = (_ - L(w)) / y, M = (_ + L(w)) / y, S = [n[u]], T > n[u] && T < n[u + 1] && S.push(T), M > n[u] && M < n[u + 1] && S.push(M), S.push(n[u + 1])), R = S[0], T = this._at(R, u), c = 0; c < S.length - 1; c++)
							if (C = S[c + 1], M = this._at(C, u), 0 !== T)
								if (0 === M || T * M > 0) R = C, T = M;
								else {
									for (var F = 0; !((I = (T * C - M * R) / (T - M)) <= R || I >= C);)
										if ((P = this._at(I, u)) * M > 0) C = I, M = P, -1 === F && (T *= .5), F = -1;
										else {
											if (!(P * T > 0)) break;
											R = I, T = P, 1 === F && (M *= .5), F = 1
										}
									v.push(I), R = S[c + 1], T = this._at(R, u)
								} else v.push(R), R = C, T = M;
						0 === M && v.push(C)
					}
					t[s] = v
				}
				...
				for (m = i(t); z < r;) {
					...
					for (b = 1, c = M(m, v), x = t; z < r && !(b * S < n) && (x = R(t, g = A(v, b)), (u = e(x)) - d >= .1 * b * c || isNaN(u));) b *= .5, ++z;
					if (b * S < n) {
					...
					w = M(_ = P(p = i(x), m), g), y = M(T, _), T = P(R(T, A((w + M(_, y)) / (w * w), C(g, g))), I(R(C(y, g), C(g, y)), w)), t = x, d = u, m = p, ++z
				}
				return {
					solution: t,
					f: d,
				...
				for ("function" == typeof a && (g = a(e, n)); e < t && z < o;)
					if (++z, e + F > t && (F = t - e), s = i(e + A[0] * F, E(n, k(.2 * F, b[L]))), u = i(e + A[1] * F, E(E(n, k(T[0] * F, b[L])), k(T[1] * F, s))), c = i(e + A[2] * F, E(E(E(n, k(M[0] * F, b[L])), k(M[1] * F, s)), k(M[2] * F, u))), l = i(e + A[3] * F, E(E(E(E(n, k(P[0] * F, b[L])), k(P[1] * F, s)), k(P[2] * F, u)), k(P[3] * F, c))), d = i(e + A[4] * F, E(E(E(E(E(n, k(R[0] * F, b[L])), k(R[1] * F, s)), k(R[2] * F, u)), k(R[3] * F, c)), k(R[4] * F, l))), f = i(e + F, m = E(E(E(E(E(n, k(b[L], F * C[0])), k(u, F * C[2])), k(c, F * C[3])), k(l, F * C[4])), k(d, F * C[5]))), (p = "number" == typeof (h = E(E(E(E(E(k(b[L], F * D[0]), k(u, F * D[2])), k(c, F * D[3])), k(l, F * D[4])), k(d, F * D[5])), k(f, F * D[6]))) ? U(h) : N(h)) > r) {
							...
							if (x = a(Y, S[L - 1]), V(_ = W(H(g, 0), H(0, x))) || (X = Y, g = x, x = a(Y = e + F, m), _ = W(H(g, 0), H(0, x))), V(_)) {
								for (var Z, K, Q = 0, J = 1, $ = 1;;) {
									if ("number" == typeof g) q = ($ * x * X - J * g * Y) / ($ * x - J * g);
										...
										for (q = Y, v = g.length - 1; - 1 !== v; --v) g[v] < 0 && x[v] > 0 && (q = O(q, ($ * x[v] * X - J * g[v] * Y) / ($ * x[v] - J * g[v]))); if (q <= X || q >= Y) break;
									K = a(q, j = G._at(q, L - 1)), V(Z = W(H(g, 0), H(0, K))) ? (Y = q, x = K, _ = Z, $ = 1, -1 === Q ? J *= .5 : J = 1, Q = -1) : (X = q, g = K, J = 1, 1 === Q ? $ *= .5 : $ = 1, Q = 1)
								}
								return m = G._at(.5 * (e + q), L - 1), G.f[L] = i(q, j), G.x[L] = q, G.y[L] = j, G.ymid[L - 1] = m, G.events = _, G.iterations = z, G
							}
						}
						e += F, n = m, g = x, F = O(.8 * F * B(r / p, .25), 4 * F)
					}
				return G.iterations = z, G
			...
			function (e) {
				...
				function i(e, t, n, i, r, o, a, s, u, c, l, d, f, h, v, m) {
					...
					C = Math.min(i, c), x = 2 * i + C * (C + 5) / 2 + 2 * c + 1, N = 1e-60;
					do {
						B = 1 + .1 * (N += N), V = 1 + .2 * N
					} while (B <= 1 || V <= 1);
					...
					function G() {
						...
						if (Math.abs(D) <= N) {
							if (O) return m[1] = 1, 999;
							for (p = 1; p <= f; p += 1) v[P + p] = v[P + p] - L * v[S + p];
							return v[P + f + 1] = v[P + f + 1] + L, 700
						}
						for (D = 0, p = 1; p <= i; p += 1) D += v[b + p] * a[p][R];
						for (F = -v[M + R] / D, U = !0, O || L < F && (F = L, U = !1), p = 1; p <= i; p += 1) r[p] = r[p] + F * v[b + p], Math.abs(r[p]) < N && (r[p] = 0);
						...
						for (d[f += 1] = R, x = T + (f - 1) * f / 2 + 1, p = 1; p <= f - 1; p += 1) v[x] = v[p], x += 1;
						if (f === i) v[x] = v[i];
						else {
							for (p = i; p >= f + 1 && 0 !== v[p] && (z = Math.max(Math.abs(v[p - 1]), Math.abs(v[p])), E = Math.min(Math.abs(v[p - 1]), Math.abs(v[p])), A = v[p - 1] >= 0 ? Math.abs(z * Math.sqrt(1 + E * E / (z * z))) : -Math.abs(z * Math.sqrt(1 + E * E / (z * z))), z = v[p - 1] / A, E = v[p] / A, 1 !== z); p -= 1)
								if (0 === z)
									for (v[p - 1] = E * A, g = 1; g <= i; g += 1) A = e[g][p - 1], e[g][p - 1] = e[g][p], e[g][p] = A;
								else
									for (v[p - 1] = A, k = E / (1 + z), g = 1; g <= i; g += 1) A = z * e[g][p - 1] + E * e[g][p], e[g][p] = k * (e[g][p - 1] + A) - e[g][p], e[g][p - 1] = A;
							v[x] = v[f]
						}
						return 0
					}
					...
					function j() {
						...
						if (0 === z) {
							...
							for (k = E / (1 + z), p = w + 1; p <= f; p += 1) A = z * v[_ - 1] + E * v[_], v[_] = k * (v[_ - 1] + A) - v[_], v[_ - 1] = A, _ += p;
							for (p = 1; p <= i; p += 1) A = z * e[p][w] + E * e[p][w + 1], e[p][w + 1] = k * (e[p][w] + A) - e[p][w + 1], e[p][w] = A
						}
						return 0
					}
	...
	function (e, t, n) {
		...
		t.init = function (e) {
			...
			function () {
				...
				for (var y = new Uint16Array(4 * r * 6), w = 0, b = 0, S = 1, T = 4, M = 5, P = void 0, R = 0; R < r; R++)
					for (var C = 0; C < 4; C++) P = 3 === C ? -4 : 0, y[w + 0] = b, y[w + 1] = S + P, y[w + 2] = T, y[w + 3] = S + P, y[w + 4] = M + P, y[w + 5] = T, b++, S++, T++, M++, w += 6;
		...
		t.preInit = function (e) {
			M = e, a.loader.add(o.assetPath + "visuals/homeAbout/bg.buf", {
				...
				onLoad: function (e) {
					...
					o += 32768;
					var R = new Uint16Array(e, o, 48447);
					(z = new i.BufferGeometry).setAttribute("a_position", new i.BufferAttribute(a, 2, !0)), z.setAttribute("a_offsetRatioXY13", new i.BufferAttribute(u, 4, !0)), z.setAttribute("a_offsetRatioXY24", new i.BufferAttribute(c, 4, !0)), z.setAttribute("a_normalXY13", new i.BufferAttribute(M, 4, !0)), z.setAttribute("a_normalXY24", new i.BufferAttribute(P, 4, !0)), z.setIndex(new i.BufferAttribute(R, 1)),
					function () {
						...
						T = new i.RawShaderMaterial({
							...
							depthWrite: !1,
							blending: i.NoBlending
						}), (d = t.mesh = new i.Mesh(z, F)).renderOrder = -100, d.frustumCulled = !1
					}()
				}
			})
			...
			k = t.simWidth = Math.ceil(e * M.bgDownScale), O = t.simHeight = Math.ceil(n * M.bgDownScale), m.setSize(k, 2 * O), p.setSize(k, O), g.setSize(k, O), r.isMobile || _.setSize(Math.ceil(k / 4 | 0), Math.ceil(O / 4 | 0));
			l.u_patternTexelSize.value.set(1 / k, 1 / O), l.u_aspect.value.set(k / O, 1);
			var i = s.getColorState();
			s.clearColorRGBA(1, 0, .5, .5, p), s.setColorState(i), T.uniforms.u_randomSeed.value.set(Math.random(), Math.random(), Math.random(), Math.random()), s.render(T, m), s.render(S, p), E = 0
		}, t.update = function (e) {
			...
			if (v.uniforms.u_mouse.value.set(.5 * N(i, o) + .5, .5 * o + .5), t.isSimActive) {
				...
				for (var m = 0; m < 6; m++) U(), w.uniforms.u_noiseUvOffset.value = (w.uniforms.u_noiseUvOffset.value + .1 * e) % 1, s.render(w, p);
				U(), s.render(b, p), s.setColorState(d);
				var g = M.themeRatio;
				...
				var S = c.clamp(i, -1, 1),
					...
					k = Math.atan2(T, S);
				s.render(v, x), r.isMobile || (s.copy(x.texture, _), u.blur9(4, .5, _)), F.uniforms.u_constraintedMouse.value.set(Math.cos(k) * z, Math.sin(k) * z), E += o <= -1 || o >= 1 ? .1 * (0 - E) : .1 * (1 - E);
				var O = F.uniforms.u_clothEffectRatio.value = E;
				F.uniforms.u_baseBlendRatio.value = (.1 + .9 * c.clamp(c.smoothstep(0, .3, z), 0, 1)) * O, l.u_rotation.value = M.expandRatio
			}
		};
	...
	function (e, t, n) {
		...
		var v = c.prototype,
			m = h.prototype = Object.create(v);
		m.constructor = h, m.preInit = function () {
			v.preInit.call(this), this.sceneRenderTarget = l.createRenderTarget(1, 1, !0), this.sceneRenderTarget.depthBuffer = !0, this.sceneRenderTarget.stencilBuffer = !0, this.blurredSceneRenderTarget = l.createRenderTarget(1, 1, !0), f.init(), (C = new u.Texture(o.loader.add(r.cdnPath + "visuals/homeVideo/model_n.jpg").content)).wrapS = C.wrapT = u.RepeatWrapping, C.magFilter = C.minFilter = u.LinearFilter, C.flipY = !1, C.needsUpdate = !0, (I = new u.Texture(o.loader.add(r.cdnPath + "visuals/homeVideo/bottom_n.jpg", {
				loadThrough: !1
			...
			}).content).addEventListener("ended", ie), (R = new u.Texture(P)).magFilter = R.minFilter = u.LinearFilter, R.generateMipmaps = !1;
			var e = this;
			...
			if (v.init.call(this), g = a.powerTwoCeilingBase(D), x = p * g, y = l.createRenderTarget(x, _, !0, !0), w = new Uint8Array(x * _ * 4), (b = new u.BufferGeometry).setAttribute("position", new u.BufferAttribute(new Float32Array([-1, -1, 0, 4, -1, 0, -1, 4, 0]), 3)), b.setAttribute("uv", new u.BufferAttribute(new Float32Array([0, 1, x / this.videoWidth * 2.5, 1, 0, 1 - _ / this.videoHeight * 2.5]), 2)), F.u_timePixelUvClamp.value.set((x + .5) / this.videoWidth, 1 - (p + .5) / this.videoHeight), S = new u.RawShaderMaterial({
				...
				i.addColor(k, "color"), i.add(this, "mouseProjectionDistanceRatio", 0, 2, 1e-4), i.add(k, "intensity", 0, 1, 1e-4), i.add(k, "distance", 0, 50, 1e-4), i.add(k, "decay", 0, 5, 1e-4), i.open();
				var r = e.addFolder("video playback");
				r.add(P, "play"), r.add(P, "pause"), r.open()
			}
			this.precompile()
		}, m._initMaterials = function (e) {
			O = new u.Vector3(0, 0, 0), F = {
				u_videoTexture: {
					value: R
				},
				u_videoAspect: {
			...
			for (; t--;) {
				...
				case "bottom":
					...
					break;
				case "panel":
					E = r, o.u_diffuse.value.setHex(0), o.u_specular.value.setHex(0), o.u_reflectionTexture = {
			...
			w.rotateX(Math.PI / 2), E.rotation.x = 0, w.translate(b.x, b.y, b.z), w.scale(S.x, S.y, S.z), E.position.set(-b.x, -b.y, -b.z), E.scale.set(1 / S.x, 1 / S.y, 1 / S.z)
		}, m.resize = function () {
			...
			var r = T.length;
			for (; r--;) T[r].visible = !1;
			z.visible = !0, e.render(this.scene, this.camera), r = T.length;
			for (; r--;) T[r].visible = !0;
			z.visible = !1, l.renderGeometry(N, B), e.setScissorTest(!1), l.setColorState(t)
		}, m.update = function (e) {
			if (this.testViewport(), this.needsRender) {
				...
				m !== V && (V = m, TweenLite.to(B.uniforms.u_showRatio, m ? 2 : 1.35, {
					value: m ? 1 : 0
				})), B.uniforms.u_time.value = (B.uniforms.u_time.value + .2 * e) % 1, k.position.copy(this.mouse3), k.position.y = Math.max(k.position.y, .04), O.copy(k.position), this.camera.position.copy(M.position), this.camera.quaternion.copy(M.quaternion), this.camera.rotateY(-.015 * a.clamp(this.mouse.x, -1, 1)), this.camera.rotateX(.015 * a.clamp(this.mouse.y, -1, 1)), this.scene.updateMatrixWorld(!0), this.camera.updateMatrixWorld(!0), M.updateMatrixWorld(!0);
	...
	function (e, t, n) {
		...
		t.init = function () {
			...
			if (void 0 !== P) {
				var R = r.getSize(),
					C = r.getPixelRatio();
				p.x = P.x * R.width * C, p.y = P.y * R.height * C, p.z = P.z * R.width * C, p.w = P.w * R.height * C, r.state._viewport(p)
			}
			e.visible = !0;
	...
	function (e, t, n) {
		...
		var i = n(5),
			...
			u = n(0);
		t.preInit = function (e) {
			v = e, (c = t.container = new u.Object3D).position.z = -2, s.preInit(e), c.add(s.container), _ = n(204).replace(/#define\sGLSLIFY\s./, ""), w = n(205).replace(/#define\sGLSLIFY\s./, ""), y = n(206).replace(/#define\sGLSLIFY\s./, ""), b = n(207).replace(/#define\sGLSLIFY\s./, ""), o.loader.add(r.assetPath + "visuals/contact/animation.glb", {
				type: "any",
				weight: 1,
				hasLoading: !0,
	...
	function (e, t, n) {
		...
		o.overrideDefaultMaterial = function (e, t) {
			...
			e.vertexShader = r.vertexShader, e.fragmentShader = r.fragmentShader, e.vertexShader = e.vertexShader.replace("void main() {", (this.useBlend ? "#define USE_VA_BLEND\n" : "\n") + n(201).replace(/#define\sGLSLIFY\s./, "") + "void main() {" + n(202).replace(/#define\sGLSLIFY\s./, "")), e.vertexShader = e.vertexShader.replace("#include <beginnormal_vertex>", ""), e.vertexShader = e.vertexShader.replace("#include <begin_vertex>", ""), this.useNormalImage && e.defines && (e.defines.USE_VA_NORMAL_TEXTURE = !0);
			return e
	...
	function (e, t, n) {
		...
		t.checkIsSupported = function (e, t) {
			...
			p(i.canvas), l.addChunk("getScatter", n(212)), l.addChunk("getScatterLine", n(213)), l.addChunk("cubic", n(214)), l.addChunk("textureBicubic", n(215)), l.addChunk("textureLodBicubic", n(216)), l.addChunk("snoise2", n(217)), l.addChunk("snoise3", n(218)), l.addChunk("snoise4", n(219)), l.addChunk("rotate2d", n(220)), l.addChunk("curl4Low", n(221)), l.addChunk("curl4Mid", n(222)), l.addChunk("simplexNoiseDerivatives4", n(223)), l.addChunk("encodeNormal", n(224)), l.addChunk("decodeNormal", n(225)), l.addChunk("halfFloatPacking", n(226)), l.addChunk("samplePackedFloats", n(227)), (v = i.renderer = new h.WebGLRenderer({
				canvas: i.canvas,
				context: i.gl
			})).shadowMap.type = h.PCFShadowMap, v.shadowMap.enabled = !0, c.init(v, r.renderTargetFloatType, r.dataFloatType), i.resolution = new h.Vector2, i.GLTFLoader = new a, i.GLTFLoadFunc = s.createQuickLoadFunc(i.GLTFLoader), u.init(), m = new h.Vector2
		...
		function p(e, t) {
			if (!r.gl) {
				...
				return (n.getExtension("OES_texture_float") || n.getExtension("OES_texture_half_float")) && n.getParameter(n.MAX_VERTEX_TEXTURE_IMAGE_UNITS) ? (r.renderTargetFloatType = o.isIOS || !n.getExtension("OES_texture_float") ? h.HalfFloatType : h.FloatType, r.dataFloatType = h.FloatType, r.useFloatPacking = !1) : (r.renderTargetFloatType = r.dataFloatType = h.UnsignedByteType, r.useFloatPacking = !0), !0
			}
			return !1
		}
	},
		...
		e.exports = r.GLTFLoader = function () {
			...
			f.prototype.decodePrimitive = function (e, t) {
				...
				for (c in e.attributes)
					if (void 0 !== R[c] && void 0 !== o[c]) {
						var l = n.accessors[e.attributes[c]],
							d = S[l.componentType];
						u[R[c]] = d, s[R[c]] = !0 === l.normalized
					}
			...
			function W(e, t, n) {
				...
				return k(e, t), Promise.all(r).then(function () {
			...
			return H.prototype.parse = function (e, t) {
				...
				return void 0 !== i.bufferView ? o.push(this.getDependency("bufferView", i.bufferView)) : o.push(null), void 0 !== i.sparse && (o.push(this.getDependency("bufferView", i.sparse.indices.bufferView)), o.push(this.getDependency("bufferView", i.sparse.values.bufferView))), Promise.all(o).then(function (e) {
					...
					} else o = null === s ? new c(i.count * u) : new c(s, f, i.count * u), a = new r.BufferAttribute(o, u, v); if (void 0 !== i.sparse) {
						var g = P.SCALAR,
				...
				return v === L ? s.transparent = !0 : (s.transparent = !1, v === D && (s.alphaTest = void 0 !== a.alphaCutoff ? a.alphaCutoff : .5)), void 0 !== a.normalTexture && t !== r.MeshBasicMaterial && (c.push(this.assignTexture(s, "normalMap", a.normalTexture)), s.normalScale = new r.Vector2(1, 1), void 0 !== a.normalTexture.scale && s.normalScale.set(a.normalTexture.scale, a.normalTexture.scale)), void 0 !== a.occlusionTexture && t !== r.MeshBasicMaterial && (c.push(this.assignTexture(s, "aoMap", a.occlusionTexture)), void 0 !== a.occlusionTexture.strength && (s.aoMapIntensity = a.occlusionTexture.strength)), void 0 !== a.emissiveFactor && t !== r.MeshBasicMaterial && (s.emissive = (new r.Color).fromArray(a.emissiveFactor)), void 0 !== a.emissiveTexture && t !== r.MeshBasicMaterial && c.push(this.assignTexture(s, "emissiveMap", a.emissiveTexture)), Promise.all(c).then(function () {
					var e;
					return e = t === r.ShaderMaterial ? o[n.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS].createMaterial(s) : new t(s), void 0 !== a.name && (e.name = a.name), e.normalScale && (e.normalScale.y = -e.normalScale.y), e.map && (e.map.encoding = r.sRGBEncoding), e.emissiveMap && (e.emissiveMap.encoding = r.sRGBEncoding), e.specularMap && (e.specularMap.encoding = r.sRGBEncoding), k(e, a), a.extensions && E(o, e, a), e
				})
				...
				return Promise.all(u).then(function (i) {
					return t.loadGeometries(s).then(function (u) {
						for (var c = 1 === u.length && u[0].groups.length > 0, l = [], d = 0, f = u.length; d < f; d++) {
							...
							Object.keys(h.geometry.morphAttributes).length > 0 && O(h, a), h.name = a.name || "mesh_" + e, u.length > 1 && (h.name += "_" + d), k(h, a), l.push(h);
							for (var T = c ? h.material : [h.material], M = void 0 !== v.attributes.color, P = void 0 === v.attributes.normal, R = !0 === h.isSkinnedMesh, C = Object.keys(v.morphAttributes).length > 0, I = C && void 0 !== v.morphAttributes.normal, A = 0, D = T.length; A < D; A++) {
								...
								if (h.isPoints) {
									...
									var z = t.cache.get(L);
									z || (z = new r.LineBasicMaterial, r.Material.prototype.copy.call(z, S), z.color.copy(S.color), z.lights = !1, t.cache.add(L, z)), S = z
								}
								if (M || P || R || C) {
									L = "ClonedMaterial:" + S.uuid + ":";
									S.isGLTFSpecularGlossinessMaterial && (L += "specular-glossiness:"), R && (L += "skinning:"), M && (L += "vertex-colors:"), P && (L += "flat-shading:"), C && (L += "morph-targets:"), I && (L += "morph-normals:");
									var E = t.cache.get(L);
									E || (E = S.isGLTFSpecularGlossinessMaterial ? o[n.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS].cloneMaterial(S) : S.clone(), R && (E.skinning = !0), M && (E.vertexColors = r.VertexColors), P && (E.flatShading = !0), C && (E.morphTargets = !0), I && (E.morphNormals = !0), t.cache.add(L, E)), S = E
								}
				...
				var t, n = this.json.cameras[e],
					i = n[n.type];
				if (i) return "perspective" === n.type ? t = new r.PerspectiveCamera(r.Math.radToDeg(i.yfov), i.aspectRatio || 1, i.znear || 1, i.zfar || 2e6) : "orthographic" === n.type && (t = new r.OrthographicCamera(i.xmag / -2, i.xmag / 2, i.ymag / 2, i.ymag / -2, i.znear, i.zfar)), void 0 !== n.name && (t.name = n.name), k(t, n), Promise.resolve(t);
				...
				return function (t) {
					var n = this.json,
						...
						a = new r.Scene;
					void 0 !== o.name && (a.name = o.name), k(a, o), o.extensions && E(i, a, o);
			...
			c.prototype = {
				...
				noise4D: function (e, t, n, i) {
					var r, o, a, c, l, d, f, h, v, m, p, g, x, _, y, w, b, S = this.perm,
						...
						O = 0,
						U = 0;
					D > L ? E++ : k++, D > F ? E++ : O++, D > z ? E++ : U++, L > F ? k++ : O++, L > z ? k++ : U++, F > z ? O++ : U++;
					var N = D - (d = E >= 3 ? 1 : 0) + u,
						B = L - (f = k >= 3 ? 1 : 0) + u,
						V = F - (h = O >= 3 ? 1 : 0) + u,
						H = z - (v = U >= 3 ? 1 : 0) + u,
	...
	function (e, t, n) {
		...
		! function () {
			...
			function N(e, t, n) {
				for (var i in k)
					if (k.hasOwnProperty(i) && t === e.f[k[i]] && n === e.f[k[i]]) return !0;
				return !1
			}
			...
			function B(e) {
				var t, n = e.g.a.offsetWidth,
					i = e.h.a.offsetWidth;
				(t = n === e.f.serif && i === e.f["sans-serif"]) || (t = U() && N(e, n, i)), t ? s() - e.A >= e.w ? U() && N(e, n, i) && (null === e.u || e.u.hasOwnProperty(e.a.c)) ? V(e, e.v) : V(e, e.B) : function (e) {
				...
				(e.f || e.g) && setTimeout(function () {
					...
					if (0 === n.length && o) C(t.a);
						...
						for (u = 0; u < n.length; u++) {
							...
							f = W ? new z(a(t.g, t), a(t.h, t), t.c, l, t.s, d) : new E(a(t.g, t), a(t.h, t), t.c, l, t.s, e, d), c.push(f)
						}
